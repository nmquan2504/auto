...
namespace Auto
{
    class TypeTextAction : Action
    {
        ...
        public void SendString(string inputStr)
        {
                    ...
                    case 8: // Translate \t to VK_TAB
                        {
                            ...
                            keyDown.union.keyboardInput.wVk = VirtualKeyShort.TAB;
                            ...
                            keyUp.union.keyboardInput.wVk = VirtualKeyShort.TAB;
                            keyUp.union.keyboardInput.dwFlags = KEYEVENTF.KEYUP;
                    ...
                    case 10: // Translate \n to VK_RETURN
                        {
                            INPUT keyDown = new INPUT();
                            keyDown.type = 1; //Keyboard
                            keyDown.union.keyboardInput.wVk = VirtualKeyShort.RETURN;
                            keyDown.union.keyboardInput.dwFlags = 0;
                            keyDown.union.keyboardInput.wScan = 0; //use VirtualKey
                            keyList.Add(keyDown);
                            INPUT keyUp = new INPUT();
                            keyUp.type = 1; //Keyboard
                            keyUp.union.keyboardInput.wVk = VirtualKeyShort.RETURN;
                            keyUp.union.keyboardInput.dwFlags = KEYEVENTF.KEYUP;
                            keyUp.union.keyboardInput.wScan = 0; //use VirtualKey
                            keyList.Add(keyUp);
                        }
                    ...
                    default:
                        {
                            ...
                            keyDown.union.keyboardInput.dwFlags = KEYEVENTF.UNICODE; //Unicode Key Down
                            keyDown.union.keyboardInput.wScan = (ScanCodeShort)c;
                            keyList.Add(keyDown);
                            INPUT keyUp = new INPUT();
                            keyUp.type = 1; //Keyboard
                            keyUp.union.keyboardInput.wVk = 0; //Use unicode
                            keyUp.union.keyboardInput.dwFlags = KEYEVENTF.UNICODE | KEYEVENTF.KEYUP; //Unicode Key Up
                            keyUp.union.keyboardInput.wScan = (ScanCodeShort)c;
                            keyList.Add(keyUp);
                        }
                        break;
                }
